	...
	<div class="help-message">
		<div class="container">
			...
			<ul class="list-unstyled">
				<li><i class="fas fa-phone"></i><span>01010010101010</span></li>
				<li><i class="fas fa-envelope"></i><span>msmsmsm@gmail.com</span></li>
			</ul>
			<div class="form-group">
			  <textarea class="form-control" id="exampleFormControlTextarea1" rows="6" placeholder="رسالتك"></textarea>
